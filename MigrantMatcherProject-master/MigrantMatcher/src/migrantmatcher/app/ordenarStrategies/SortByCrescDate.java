 ...
 */
public class SortByCrescDate implements ISortAjudaStrategy {

	@Override
	public void ordAjudas(CatalogoAjuda catAjuda) {

		Collections.sort(catAjuda.catalogoToList(catAjuda), new SortByDate());
	}

	@Override
	public List<Ajuda> ordAjudasPossiveis(CatalogoAjuda catAjuda, String regiao) {
		List<Ajuda> result = catAjuda.getAjudasPossiveis(regiao);
